...
import { shareCaption, xShareUrl, type SharePayload } from "@/lib/share";
    ...
    >
      ...
      >
        ...
        <div className="px-5 pt-4 pb-5">
          ...
          <a
            href={xShareUrl(payload, caption)}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 flex items-center justify-center gap-2 w-full bg-[#141210] text-[#FAF8F5] px-5 py-3 rounded-full text-[15px] font-semibold hover:bg-accent hover:text-foreground transition-colors"
          >
            Post on X
          </a>
          <button
            type="button"
            onClick={onClose}
            className="mt-2 w-full py-2 text-[13px] font-medium text-secondary hover:text-foreground transition-colors"
          >
            Not now
          </button>
        </div>
